...
const About = () => {
    return (
      ...
      <div className='aboutheader'>
          ...
          <div class="item" data-aos="fade-up">All of Cincinnati shuts down for Opening Day. As home to the first pro baseball team, we take the sport very seriously</div>
