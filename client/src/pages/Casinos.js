    ...
    return (
      ...
      <div className='aboutheader'>
        ...
        <div className = 'singleattraction'>
                <a href="https://www.hollywoodindiana.com/"target="_blank" rel="noreferrer"><h1>Hollywood Casino Lawrenceburg</h1></a>
            <img src="https://images2.imgbox.com/7c/9f/eD0Sbg2G_o.png" alt=""/>
            <p>777 Hollywood Blvd, Lawrenceburg, IN 47025</p>
            </div>
             <div className = 'singleattraction'>
                <a href="https://miamivalleygaming.com/" target="_blank" rel="noreferrer"><h1>Miami Valley Gaming</h1></a>
            <img src= "https://images2.imgbox.com/72/de/anZIJQca_o.png" alt=" img"/>
            <p>6000 OH-63, Lebanon, OH 45036</p>
            </div>
            <div className = 'singleattraction'>
                <a href="https://www.hardrockcasinocincinnati.com/en" target="_blank" rel="noreferrer"><h1>Hard Rock Casino</h1></a>
            ...
            <div className = 'singleattraction'>
                <a href="https://www.newportrg.com/" target="_blank" rel="noreferrer"><h1>Newport Racing & Gaming</h1></a>
            ...
            <div className = 'singleattraction'>
                <a href="https://www.belterrapark.com/" target="_blank" rel="noreferrer"><h1>Belterra Park Gaming & Entertainment</h1></a>
